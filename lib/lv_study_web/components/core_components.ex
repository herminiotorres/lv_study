defmodule LvStudyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvStudyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvStudyWeb.Gettext, "errors", msg, opts)
    end
  end
