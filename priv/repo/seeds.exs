...
#
#     LvStudy.Repo.insert!(%LvStudy.SomeSchema{})
#
# We recommend using the bang functions (`insert!`, `update!`
# and so on) as they will fail if something goes wrong.

alias LvStudy.Repo
alias LvStudy.Boats.Boat
...
# alias LvStudy.Donations.Donation
...
# alias LvStudy.Athletes.Athlete
...
# alias LvStudy.PizzaOrders.PizzaOrder
